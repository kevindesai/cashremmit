    ...
    <body class="animated-content infobar-overlay">
        ...
        <header id="topnav" class="navbar navbar-default navbar-fixed-top" role="banner">
            ...
            <div class="logo-area">
                ...
                <a class="navbar-brand" href="index.html">December</a>

                <ul class="nav navbar-nav hidden-xs">
                    <li>
                        <a href="#"><i class="fa fa-plus"></i> New project</a>
                    </li>
                </ul>
            ...
            <ul class="nav navbar-nav toolbar pull-right">
                ...
                <li class="dropdown toolbar-icon-bg hidden-xs">
                    ...
                    <ul class="dropdown-menu userinfo">
                        ...
                        <li class="divider"></li>
                        <li><a href="#/"><i class="fa fa-bar-chart-o"></i><span>Earnings</span></a></li>
                        <li><a href="#/"><i class="fa fa-list"></i><span>Statement</span></a></li>
                ...
                <li class="dropdown toolbar-icon-bg">
                    <a href="#" class="hasnotifications dropdown-toggle" data-toggle='dropdown'><span class="icon-bg"><i class="fa fa-bell"></i></span><span class="badge badge-info">2</span></a>
                        ...
                        <div class="scroll-pane">
                            <ul class="media-list scroll-content">
                                <li class="media notification-success">
                                    <a href="#">
                                        <div class="media-left">
                                            <span class="notification-icon"><i class="fa fa-lock"></i></span>
                                        </div>
                                ...
                                <li class="media notification-info">
                                    <a href="#">
                                        <div class="media-left">
                                            <span class="notification-icon"><i class="fa fa-cart-plus"></i></span>
                                        </div>
                                        <div class="media-body">
                                ...
                                <li class="media notification-teal">
                                    <a href="#">
                                        <div class="media-left">
                                            <span class="notification-icon"><i class="fa fa-calendar"></i></span>
                                        </div>
                                        <div class="media-body">
                                ...
                                <li class="media notification-indigo">
                                    <a href="#">
                                        <div class="media-left">
                                            <span class="notification-icon"><i class="fa fa-gear"></i></span>
                                        </div>
                                        <div class="media-body">
                                ...
                                <li class="media notification-danger">
                                    <a href="#">
                                        <div class="media-left">
                                            <span class="notification-icon"><i class="fa fa-comments-o"></i></span>
                                        </div>
                                        <div class="media-body">
                            ...
                            <ul class="media-list scroll-content">
                                ...
                                <li class="media notification-message">
                                    <a href="#">
                                        ...
                                        <div class="media-body">
                                            <h4 class="notification-heading"><strong>Brian Fisher</strong> <span class="text-gray">‒ Praesent dapibus, neque id cursus faucibus, tortor neque egestas augue.</span></h4>
                                            <span class="notification-time">16 hours ago</span>
                                        </div>
                                    </a>
                                </li>
                                <li class="media notification-message">
                                    <a href="#">
                                        ...
                                        <div class="media-body">
                                            <h4 class="notification-heading"><strong>Dylan Black</strong> <span class="text-gray">‒ Pellentesque fermentum dolor. Aliquam quam lectus, facilisis auctor.</span></h4>
                                            <span class="notification-time">2 days ago</span>
                                        </div>
                                    </a>
                                </li>
                                <li class="media notification-message">
                                    <a href="#">
                                        ...
                                        <div class="media-body">
                                            <h4 class="notification-heading"><strong>Bobby Harper</strong> <span class="text-gray">‒ Sed adipiscing ornare risus. Morbi est est, blandit sit amet.</span></h4>
                                            <span class="notification-time">4 days ago</span>
                                        </div>
                                    </a>
                                </li>
